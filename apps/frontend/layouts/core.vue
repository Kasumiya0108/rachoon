    ...
    <div class="navbar bg-base-300 fixed z-50 shadow-lg">
      <div class="container mx-auto">
          ...
          <ul class="menu menu-horizontal p-0 gap-2">
            ...
            <li>
              <NuxtLink
                ...
                class="h-8 p-5 rounded-lg"
                :class="
                  useRoute().fullPath.includes('/clients') ? 'active' : ''
                "
            ...
            <li>
              <NuxtLink
                ...
                class="h-8 p-5 rounded-lg"
                :class="
                  useRoute().fullPath.includes('/invoices') ? 'active' : ''
                "
              >
        ...
        <div class="dropdown dropdown-hover dropdown-end">
          <label
            tabindex="0"
            class="btn rounded-full bg-transparent hover:bg-transparent border-none"
          >
            ...
            <span class="ml-3 text-success"
              >Hi, {{ useProfile().me?.data.username }}</span
            >
          </label>

          <ul
            tabindex="0"
            class="dropdown-content menu menu-compact p-2 shadow bg-base-300 border-error rounded-box w-52"
          >
            <li>
              <NuxtLink
                href="/profile"
                :class="
                  useRoute().fullPath.includes('/profile') ? 'active' : ''
                "
            ...
            <li>
              <NuxtLink
                href="/settings"
                :class="
                  useRoute().fullPath.includes('/settings') ? 'active' : ''
                "
              >
